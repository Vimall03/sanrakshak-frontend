...
const TaskChangesComment = ({
  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center w-[35rem]   register-fir-bg  ">
        <div className=" pt-[2rem] flex flex-col items-center ">
          <UpdateAnimation />
          <p className=" font-inter font-[500] text-[1rem] ">
          ...
          <div className="  flex flex-col gap-[1rem] w-[100%] mt-[1rem]  ">
            ...
            <button
              ...
              className={` ${updatingTask ? "animate-pulse" : ""
                } flex gap-[.8rem] justify-center items-center bg-[#6C72FF] py-[.6rem] text-white rounded-md mt-[2rem] w-[100%] h-[2.8rem] text-[1.1rem] mx-auto   `}
            >
              {" "}
            ...
            <button
              onClick={() => onClose()}
              className=" rounded-md text-[1.1rem]  py-[.6rem] stage-no-select  "
            >
              Cancel
            </button>
          </div>
