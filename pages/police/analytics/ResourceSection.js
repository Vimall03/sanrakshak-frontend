...
export default function ResourceSection() {
  ...
  const handleToggle = (index) => {
    const updatedexpandedOfficers = [...expandedOfficers];
    updatedexpandedOfficers[index] = !expandedOfficers[index];
    setExpandedOfficers(updatedexpandedOfficers);
  };

  const [expandedArsenal, setExpandedArsenal] = useState(Array(3).fill(false)); 
  const handleToggleArsenal = (index) => {
    const updatedexpandedArsenal = [...expandedArsenal];
    updatedexpandedArsenal[index] = !expandedArsenal[index];
    setExpandedArsenal(updatedexpandedArsenal);
  }

  const [expandedCarriers, setExpandedCarriers] = useState(Array(3).fill(false)); 
  const handleToggleCarrier = (index) => {
    const updatedexpandedCarriers = [...expandedCarriers];
  ...
  return (
    <div>
      <div class="bg-[#1A2852] rounded-md h-[85vh] card-scroll w-[18rem] px-4 py-2">
        <h2 className="text-2xl font-bold">Resources</h2>
        {/* Officers section */}
        <div className="flex justify-between">
          <h2 className="text my-2 font ">Officers On Duty</h2>
          <h2 className="text my-2 font">30/54</h2>
        </div>
        <div>
        ...
        {/* Arsenal Section */}
        <div className="flex justify-between">
          <h2 className="text my-2 font ">Arsenal</h2>
          <h2 className="text my-2 font"></h2>
        </div>
        <div>
        ...
        {/* Carries Section */}
        <div className="flex justify-between">
          <h2 className="text my-2 font ">Carriers</h2>
          <h2 className="text my-2 font"></h2>
        </div>
        <div>
