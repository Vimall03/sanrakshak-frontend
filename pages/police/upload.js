            ...
            <div className=" w-[100%] h-[90vh] flex justify-center items-center">
                <div className=" flex flex-col w-[30rem]   bg-[#101935] border-[1px] border-[#6c71ff37] rounded-lg px-[2.5rem] py-[2.5rem] ">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className='text-white active:scale-95 duration-300 bg-[#6d72fe] flex justify-center items-center gap-[.5rem] px-[.5rem] py-[.25rem] rounded font-nunito font-[400] text-[1.02rem] mt-[2rem]   '>Submit</button>
                    </form>
                </div>
            </div>
        </div>
